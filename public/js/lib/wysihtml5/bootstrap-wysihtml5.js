        ...
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              ...
              "<ul class='dropdown-menu'>" +
                ...
                "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h4'><h4>" + locale.font_styles.h4 + "</h4></a></li>" +
                "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h5'><h5>" + locale.font_styles.h5 + "</h5></a></li>" +
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal hide'>" +
                ...
                "<div class='modal-body'>" +
                  "<input type=text value='http://' class='bootstrap-wysihtml5-insert-link-url span5'>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal hide'>" +
                ...
                "</div>" +
                "<div class='modal-body'>" +
                  "<input type=text value='http://' class='bootstrap-wysihtml5-insert-image-url span5'><br>" +
                  "<label>Ширина: <input value=0 type=number class='bootstrap-wysihtml5-insert-image-width input-small' placeholder='Ширина'></label>" +
                "</div>" +
                "<div class='modal-footer'>" +
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            ...
            var insertImage = function() {
                ...
                self.editor.composer.commands.exec("insertImage", imgObj);
            };
